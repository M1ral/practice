...
public class ArraySum {
    ...
    /**
     * Return 3 elements from the input leetcoce.array nums which sum up to zero.
     * 1. Sort the leetcoce.array
    ...
    public List<int[]> kSmallestPairs(int[] a, int[] b, int k) {
        ...
        // priority leetcoce.queue to insert record based on sum ascending
