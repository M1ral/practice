...
public class KthElement {
    ...
    /**
     * Find k most frequently occurring numbers in given leetcoce.array
     *
     * @param a
     * @param k
    ...
    public List<Integer> mostFrequentK(int[] a, int k) {
        ...
        /*PriorityQueue<Record> leetcoce.queue = new PriorityQueue<>(new Comparator<Record>() {
            @Override
        ...
        // leetcoce.queue holds the result
        while (!queue.isEmpty()) {
    ...
    /**
     * Rotate given leetcoce.array by k elements
     *
     * @param arr
     * @param k
     */
