...
public class LinkedListAtLevels {
    ...
    /**
     * Return the list of LinkedList for each level of the tree
     * @param root
    ...
    /**
     * Recursively construct linkedlist for each level of the tree
     *
     * @param treeNode
     * @param lists
     * @param level
    ...
    /**
     * Iteratively construct and return list of LinkedLists for each level of the tree
     * @param root
     * @return list of LinkedLists
     */
