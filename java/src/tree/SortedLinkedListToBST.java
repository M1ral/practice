...
import static tree.LinkedListAtLevels.getLinkedListAtEachDepth;
import static tree.LinkedListAtLevels.printLists;
...
public class SortedLinkedListToBST {
    ...
    private static TreeNode addToTree(int start, int end) {
        ...
        h = h.next; // while performing Inorder traversal, visit next node of the linkedlist
