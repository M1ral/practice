...
public class Trie {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("leetcoce.trie.search(\"ab\") = " + trie.search("ab"));
        System.out.println("leetcoce.trie.search(\"acd\") = " + trie.search("acd"));
        System.out.println("leetcoce.trie.search(\"abcd\") = " + trie.search("abcd"));
        ...
        System.out.println("leetcoce.trie.search(\"ab\") = " + trie.searchRecursive("ab", trie.root, 0));
        System.out.println("leetcoce.trie.search(\"acd\") = " + trie.searchRecursive("acd", trie.root, 0));
        System.out.println("leetcoce.trie.search(\"abcd\") = " + trie.searchRecursive("abcd", trie.root, 0));
    }
    ...
    private boolean delete(String word, TrieNode current, int index) {
        ...
        char ch = word.charAt(index);
        TrieNode node = current.children.get(ch);
        // if there is no downstream leetcoce.trie node for given character, return false
        if (null == node) {
            return false;
        }
