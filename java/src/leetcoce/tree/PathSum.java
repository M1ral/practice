...
public class PathSum {
    ...
    /**
     * Check recursively if the leetcoce.tree has a path that sums up to given number
     *
     * @param root
     * @param sum
     * @return boolean
    ...
    /**
     * Check iteratively if leetcoce.tree has path that sums up to given number
     *
     * @param root
     * @param sum
     * @return boolean
